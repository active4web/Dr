			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الحجوزات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الحجوزات</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/reservation/delete_message" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('reservations')->result();
										 if(count($tt)>0){
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td><?= mb_substr($data->name,0,20);?></td>
												<td><?=$data->phone;?></td>
												<td><?= mb_substr($data->dentist,0,20);?></td>
												<td><?= mb_substr($data->reason,0,20);?></td>
												<td><?=$data->date_time;?></td>
												<td> <a href="<?= base_url()?>admin/reservation/view_message?id=<?= $data->id_message;?>">التفاصيل</a></td>
												<td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/reservation/delete_message?id=<?= $data->id_message;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/reservation/check_view_message") ?>',
                type: 'POST',
                data: data,				
