                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-green-sharp">
                                            <span data-counter="counterup" data-value="<?php
$job_messages=$this->db->get_where("services")->result();
echo count($job_messages);?>"></span>
                                            <small class="font-green-sharp"></small>
                                        </h3>
                                        <small style="font-size:13px">الخدمات</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-envelope"></i>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="dashboard-stat2 bordered">
							<a href="<?= DIR?>admin/events">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="<?php
$job_messages=$this->db->get_where("events")->result();
echo count($job_messages);?>"></span>
                                        </h3>
                                        <small style="font-size:13px"> الاخبار</small>
                                    </div>
                                    <div class="icon">
