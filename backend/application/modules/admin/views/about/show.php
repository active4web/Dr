		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					$about_site = $result->about;
					$about_site_en = $result->about_en;
					$about_img = $result->about_img;
														...
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
<form action="<?php echo $url?>admin/about/edit_about" class="form-horizontal form-bordered"
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			...
																			<div>
																				<span class="btn default btn-file">
																					<span class="fileinput-new">صورة من نحن</span>
