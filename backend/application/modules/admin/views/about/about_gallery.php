			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">معرض الصور</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/about/delete_slider" method="POST" id="form">
...
<?php }?>
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('sliders')->result();
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												switch($location){
													case 0:
													  $location="<span class='label label-sm label-danger'>right</span>";
													  break;
													case 1:
													  $location="<span class='label label-sm label-success'>left</span>";
													  break;
													default:
													  break; 
												}
											$image=$data->img;
											$img=$url."uploads/galleries/".$image; 		
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/about/update_slider?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
											<li><a href="<?php echo base_url()?>admin/about/delete_slider?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("<?= base_url()?>admin/about/add_slider");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/about/check_view_slider") ?>',
                type: 'POST',
                data: data,				
