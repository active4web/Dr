...
<li>
						...
						<li>
							<span class="active">الخدمات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الخدمات</span>
									</div>
								</div>
...
<?php }?>
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												$image=$data->img;
												$img=$url."uploads/services/".$image; 		
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/services/edit?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/services/delete?id_services=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/services/active") ?>',
                type: 'POST',
                data: data,				
