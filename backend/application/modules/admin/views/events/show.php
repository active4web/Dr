...
<li>
						...
						<li>
							<span class="active">الأخبار</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/events/delete" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/events/edit?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/events/delete?id_events=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/events/add");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/events/delete");
	});
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/events/active") ?>',
                type: 'POST',
                data: data,				
