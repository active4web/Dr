...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
		...
		<div class="page-container">
			...
			<form action="<?php echo $url?>admin/events/add_action" class="form-horizontal form-bordered"
...
?>																																	<div class="form-group">
						...
						<input name="title" id="title" maxlength='80'   type="text" placeholder="العنوان" class="form-control" required>
